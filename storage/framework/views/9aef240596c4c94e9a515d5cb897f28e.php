                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <?php endif; ?>" type="text" name="firstName" id="firstName" value="<?php echo e($employee->firstname); ?>" placeholder="Enter First Name">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <?php endif; ?>" type="text" name="lastName" id="lastName" value="<?php echo e($employee->lastname); ?>" placeholder="Enter Last Name">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors-> has('lastName')): ?> is-invalid
                            <?php endif; ?>" type="text" name="email" id="email" value="<?php echo e($employee->email); ?>" placeholder="Enter Email">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <?php endif; ?>" type="text" name="age" id="age" value="<?php echo e($employee->age); ?>" placeholder="Enter Age">
...
<?php /**PATH C:\Users\Dell\Documents\TUGAS KULIAH\SMT 4\Pemrograman Framework\Praktikum 4\laravelController\resources\views/employee/edit.blade.php ENDPATH**/ ?>