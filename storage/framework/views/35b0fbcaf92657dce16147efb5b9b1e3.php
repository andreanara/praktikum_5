                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors-> has('firstName')): ?> is-invalid
                            <?php endif; ?>" type="text" name="firstName" id="firstName" value="<?php echo e(old('firstName')); ?>" placeholder="Enter First Name">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors-> has('lastName')): ?> is-invalid
                            <?php endif; ?>" type="text" name="lastName" id="lastName" value="<?php echo e(old('lastName')); ?>" placeholder="Enter Last Name">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors-> has('lastName')): ?> is-invalid
                            <?php endif; ?>" type="text" name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Enter Email">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors-> has('age')): ?> is-invalid
                            <?php endif; ?>" type="text" name="age" id="age" value="<?php echo e(old('age')); ?>" placeholder="Enter Age">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select name="position" id="position" class="form-select">
                            <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($position->id); ?>" <?php echo e(old('position') == $position->id ? 'selected' : ''); ?>>
...
<?php /**PATH C:\Users\Dell\Documents\TUGAS KULIAH\SMT 4\Pemrograman Framework\Praktikum 4\laravelController\resources\views/employee/create.blade.php ENDPATH**/ ?>